...
# Se formos transformar os NA's em zeros
#n.out3 %v% "PIB.CeT" = car::recode(n.out3 %v% "PIB.CeT", "NA=0")
#n.out3 %v% "Gasto.Educ" = car::recode(n.out3 %v% "Gasto.Educ", "NA=0")
#n.out3 %v% "GINI" = car::recode(n.out3 %v% "GINI", "NA=0")
#n.out3 %v% "Bound" = car::recode(n.out3 %v% "Bound", "NA=0")
#n.out3 %v% "IDH" = car::recode(n.out3 %v% "IDH", "NA=0")
...
plot(gof3)
par(mfrow=c(1,1))
texreg(fit3, center=F,caption.above=T,caption="ERGM - 2014",digits=3, single.row = T)
